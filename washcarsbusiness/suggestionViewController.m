...
- (void)initPage
{
    ...
    _iPs_POST = @"act=%@&business_id=%@&content=%@&user_phone=%@&user_pos=%@"; //请求数据POST参数模板
    
    _iPs_POSTAction = @"add_business_app_feedback";  //反馈建议
...
-(void)startRequest
{
    ...
    NSString *post = [NSString stringWithFormat:_iPs_POST,_iPs_POSTAction,_iPs_POSTID, _itemcontent , _isconnection, _isposition];
